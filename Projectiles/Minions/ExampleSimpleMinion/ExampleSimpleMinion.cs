...
namespace BetterBoneKey.Projectiles.Minions.ExampleSimpleMinion
{
	/*
	...
	public class ExampleMinionBuff : ModBuff
	{
		public override void SetDefaults() {
			DisplayName.SetDefault("Better Bone Key");
			Description.SetDefault("The Bone Key That Fights For You!");
		...
		public override void AI() {
			...
			if (foundTarget) {
				...
				if (distanceFromTarget > 40f) {
					projectile.rotation = projectile.velocity.X * 8.55f;
					projectile.rotation += 8.4f * (float)projectile.direction;
			...
			if (distanceToIdlePosition > 75f)
			{
				speed = 10f;
				projectile.rotation = projectile.velocity.X * 4.55f;
			}
			else
            {
				speed = 0f;
